...
public class ListNotifydianZanFragment extends BottomFragment {

    private final ArrayList<ListNotifyBean> mDianzan;
    @BindView(R.id.dianzan_rv)
    RecyclerView mRecyclerView;

    @SuppressLint("ValidFragment")
    public ListNotifydianZanFragment(ArrayList<ListNotifyBean> dianzan) {
    ...
    protected void initEvemtData() {
        ListNotifyAdapter adapter = new ListNotifyAdapter(mDianzan, getActivity());
    ...
    public int createLayout() {
        return R.layout.fragment_list_notifydian_zan;
    }
