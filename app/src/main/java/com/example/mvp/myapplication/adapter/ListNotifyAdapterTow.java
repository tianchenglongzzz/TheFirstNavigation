 ...
 * @date :${DATA} 22:17
 */
public class ListNotifyAdapterTow extends RecyclerView.Adapter {
    ...
    public ListNotifyAdapterTow(ArrayList<ListNotifyBean> listNotifyBeans, Activity listNotifyActivity) {
