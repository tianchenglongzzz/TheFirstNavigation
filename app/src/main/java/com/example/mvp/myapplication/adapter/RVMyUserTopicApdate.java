 ...
 * @date :${DATA} 14:29
 */
public class RVMyUserTopicApdate extends XRecyclerView.Adapter {

    private final List<MyListTopicBean.FavouritTopicListBean> data;
    private final FragmentActivity mActivity;

    public RVMyUserTopicApdate(List<MyListTopicBean.FavouritTopicListBean> data, FragmentActivity activity) {
          this.data=data;
        mActivity = activity;
