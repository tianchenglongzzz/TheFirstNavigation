...
public class ListNotifySytemFragment extends BottomFragment {


    private final ArrayList<ListNotifyBean> mSytem;
    @BindView(R.id.rv_system)
     RecyclerView mRecyclerView;

    @SuppressLint("ValidFragment")
    public ListNotifySytemFragment(ArrayList<ListNotifyBean> sytem) {
        mSytem = sytem;
    ...
    protected void initEvemtData() {
        ListNotifyAdapter adapter = new ListNotifyAdapter(mSytem, getActivity());
    ...
    public int createLayout() {
            return R.layout.fragment_list_notify_sytem;
    }
}
